    ...
    <div className='fixed w-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-xl h-full max-h-[80%] overflow-hidden'>
            <div className='flex justify-between items-center pb-7'>
                ...
                <div className='w-fit ml-auto text-2xl hover:text-green-400 cursor-pointer' onClick={onClose}>
                    <CgClose />

                </div>
            </div>

            <form className='grid p-2 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
                                        ...
                                        return(
                                            <div className='relative group'>
                                                <img src={el} 
                                                    ...
                                                    width={80} 
                                                    height={80} 
                                                    className='bg-slate-100 border rounded cursor-pointer max-h-10'
                                                    onClick={()=>{
